...
- Capability: `obscura-fetch-contract`
- 来源: `add-obscura-engine` proposal
- 变更类型: new
- 用户确认摘要: 基于端到端对比测试报告（2026-05-02），Obscura 在动态页面场景比 Scrapling fetch 快 2-3.5x，内存低 10x+，适合作为 scrapling-get 和 scrapling-fetch 之间的轻量 JS 渲染中间层
