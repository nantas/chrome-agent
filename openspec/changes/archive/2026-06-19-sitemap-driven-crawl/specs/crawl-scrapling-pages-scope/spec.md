...
- 变更类型: `added`（修正：原标注为 `modified`，但目标 capability `crawl-scrapling-pages-scope` 主 spec 从未存在，原独立 change 已被吸收删除；故这 2 个 requirement 实际是全新添加。修正于 2026-06-18 以解锁归档依赖链。）
