...
## Purpose
Provides checkpoint/resume (断点续传) support for the MediaWiki API extraction pipeline. Tracks progress via a persistent state file, allowing interrupted pipelines to skip already-completed pages on restart.
