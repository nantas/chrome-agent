# explore-skill-gates Specification

## Purpose

Define the workflow gates and result interpretation rules for the chrome-agent skill when handling explore operations and deep discovery results.
