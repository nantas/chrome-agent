# bootstrap-strategy-cli — Spec

## Purpose

Defines the `bootstrap-strategy` CLI command for generating new site strategies from existing reference strategies that share the same backend platform.
