...
- 受保护页面 → `scrapling-stealthy-fetch`
...
切换逻辑详见 [docs/playbooks/fallback-escalation.md](docs/playbooks/fallback-escalation.md) 与 [docs/playbooks/obscura-cli-preflight.md](docs/playbooks/obscura-cli-preflight.md)。
...
| `scrapling-stealthy-fetch` | `playwright_stealth` | frozen | 4 | 高保护页面、反爬挑战 |
